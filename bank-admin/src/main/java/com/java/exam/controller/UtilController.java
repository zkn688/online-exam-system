...
@RestController @Api(tags = "工具类接口") @RequestMapping("/util") @RequiredArgsConstructor
public class UtilController {
    ...
    @GetMapping("/getCodeImg") @ApiOperation(value = "获取验证码图片流")
